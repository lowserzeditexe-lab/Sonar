    ...
    <div className="flex flex-col h-full relative" style={{ background: dk ? "#060c14" : "transparent" }}>
      ...
      <div className="flex items-center justify-between px-4 py-2.5 flex-shrink-0"
        ...
        <div className="flex items-center gap-1">
          ...
          {/* E2B sandbox URL button */}
          {isSandboxLoading ? (
            <div
              title="Creating live sandbox..."
              className="flex items-center gap-1.5 px-2 py-1 rounded-lg"
              style={{
                background: dk ? "rgba(6,182,212,0.08)" : "rgba(6,182,212,0.08)",
                border: `1px solid ${dk ? "rgba(6,182,212,0.2)" : "rgba(6,182,212,0.25)"}`,
              }}
            >
              <motion.div
                animate={{ rotate: 360 }}
              ...
              />
              <span style={{ fontSize: 10, color: "#06b6d4", fontFamily: "'DM Sans', sans-serif", whiteSpace: "nowrap" }}>
                Sandbox...
              </span>
            </div>
          ) : sandboxUrl ? (
            <a
              ...
              title={`Open live preview: ${sandboxUrl}`}
              className="flex items-center gap-1.5 px-2 py-1 rounded-lg transition-all"
              style={{
                background: dk ? "rgba(16,185,129,0.1)" : "rgba(16,185,129,0.1)",
                border: `1px solid ${dk ? "rgba(16,185,129,0.25)" : "rgba(16,185,129,0.3)"}`,
                textDecoration: "none",
              }}
            ...
            >
              ...
              <span style={{ fontSize: 10, color: "#10b981", fontFamily: "'DM Sans', sans-serif", fontWeight: 600, whiteSpace: "nowrap" }}>
                Live
              </span>
              <ExternalLink style={{ width: 10, height: 10, color: "#10b981" }} />
            </a>
          ) : (
            <button
              data-testid="open-external"
              className="p-1.5 rounded transition-colors"
              style={{ color: dk ? "rgba(100,116,139,0.5)" : "rgba(40,70,130,0.4)" }}
            >
